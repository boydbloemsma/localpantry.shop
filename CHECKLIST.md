...
## Management & Admin (Nice to Have)

- [x] Limit max number of products per store
...
- [x] Clear form validation and error messages (translations)
...
- [ ] Add clicking on a product in storefront
