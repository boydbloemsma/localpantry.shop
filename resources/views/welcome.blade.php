            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p class="mt-6 text-lg/8">
                        {{ __("Get your own beautiful storefront in just a few simple steps") }}.
                    </p>
                </div>
                    ...
                    <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                        <div class="flex flex-col">
                            ...
                            <dd class="mt-4 flex flex-auto flex-col text-base/7">
                                <p class="flex-auto">
                                    {{ __("Pick a name and get a unique link like") }}
                                    <code>yourbrand.localpantry.shop</code>.
                                    {{ __("No tech skills needed") }}.
                                </p>
                            </dd>
                        </div>
                        <div class="flex flex-col">
                            ...
                            <dd class="mt-4 flex flex-auto flex-col text-base/7">
                                <p class="flex-auto">
                                    {{ __("Upload a photo, write a short description, and set prices") }}.
                                    {{ __("Show off what makes your product special") }}.
                                </p>
                            </dd>
                        </div>
                        <div class="flex flex-col">
                            <dt class="flex items-center gap-x-3 text-base/7 font-semibold">
                                ...
                                {{ __("Share your personalized link") }}
                            </dt>
                            <dd class="mt-4 flex flex-auto flex-col text-base/7">
                                <p class="flex-auto">
                                    {{ __("Share your shop with friends, family, or market visitors") }}.
                                    {{ __("Your page looks great on phones too") }}.
                                </p>
                            </dd>
                        </div>
                    </dl>
